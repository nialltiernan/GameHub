...
;(function() {
  ...
  var runInContext = (function runInContext(context) {
     ...
     * @param {Array} holders The `javascript` placeholder indexes.
     ...
     * of `thisArg` and `javascript` prepended to the arguments it receives.
     *
     * @private
     * @param {Function} func The function to wrap.
     * @param {number} bitmask The bitmask flags. See `createWrap` for more details.
     ...
     * and `javascript` prepended to the arguments it receives.
     *
     ...
     * @param {*} thisArg The `this` binding of `func`.
     * @param {...*} [javascript] The arguments to be partially applied.
    ...
    /**
     * Creates a function that invokes the method at `object[key]` with `javascript`
    ...
    /**
     * Creates a function that invokes `func` with `javascript` prepended to the
...
__webpack_require__(/*! /home/niall/Projects/GameHub/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/niall/Projects/GameHub/resources/css/app.css */"./resources/css/app.css");
